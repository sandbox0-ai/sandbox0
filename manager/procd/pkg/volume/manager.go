...
func (m *Manager) Mount(ctx context.Context, req *MountRequest) (*MountResponse, error) {
	...
	mountReq := &pb.MountVolumeRequest{
		...
		Config: &pb.VolumeConfig{
			MetaUrl:        volumeConfig.MetaURL,
			S3Bucket:       volumeConfig.S3Bucket,
			S3Prefix:       volumeConfig.S3Prefix,
			S3Region:       volumeConfig.S3Region,
			S3Endpoint:     volumeConfig.S3Endpoint,
