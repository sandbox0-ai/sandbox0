...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EgressAuthRule) DeepCopyInto(out *EgressAuthRule) {
	*out = *in
	if in.Domains != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EgressAuthRule.
func (in *EgressAuthRule) DeepCopy() *EgressAuthRule {
	if in == nil {
		return nil
	}
	out := new(EgressAuthRule)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NetworkEgressPolicy) DeepCopyInto(out *NetworkEgressPolicy) {
	*out = *in
	...
	if in.AuthRules != nil {
		...
		*out = make([]EgressAuthRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
