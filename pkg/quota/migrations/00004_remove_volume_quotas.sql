...
DELETE FROM team_quota_limits WHERE dimension IN ('volume_storage_gb', 'snapshot_storage_gb');
DELETE FROM region_quota_limits WHERE dimension IN ('volume_storage_gb', 'snapshot_storage_gb');
DELETE FROM region_quota_bootstrap WHERE dimension IN ('volume_storage_gb', 'snapshot_storage_gb');
...
-- Removed quota rows cannot be reconstructed after volume retirement.
