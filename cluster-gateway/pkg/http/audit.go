...
var sandboxAuditRoutePolicies = map[string]sandboxAuditRoutePolicy{
	...
	"POST /api/v1/sandboxes/:id/previews":                          auditMutationRoute("sandbox.preview.create"),
	"PUT /api/v1/sandboxes/:id/previews/:preview_id":               auditMutationRoute("sandbox.preview.renew"),
	"DELETE /api/v1/sandboxes/:id/previews/:preview_id":            auditMutationRoute("sandbox.preview.revoke"),
