...
func ToManager(spec *infrav1alpha1.ManagerConfig) *apiconfig.ManagerConfig {
	...
	cfg.ProcdConfig = apiconfig.ProcdConfig{
		...
		MountMode:                  spec.ProcdConfig.MountMode,
		CtldBaseURL:                spec.ProcdConfig.CtldBaseURL,
		CtldTimeout:                spec.ProcdConfig.CtldTimeout,
		NodeLocalFallbackToStorage: spec.ProcdConfig.NodeLocalFallbackToStorage,
