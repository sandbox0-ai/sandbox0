...
func Registry() []Entry {
	return []Entry{
		...
		prefix("spec.sandboxObservability", "sandbox-observability", []string{"sandbox-observability", "cluster-gateway", "manager", "netd", "status"}, []string{"InfraPlan.Components.EnableSandboxObservability"}, UpdateSemanticsDeclarative, "Region-local per-sandbox historical observability feature, retention, producer ingestion, and user-facing query APIs."),
