...
| `ANTHROPIC_API_KEY` | Model provider token stored in the LLM vault |
| `ANTHROPIC_BASE_URL` | Optional Anthropic-compatible model endpoint |
| `ANTHROPIC_MODEL` | Optional model id for the agent |
