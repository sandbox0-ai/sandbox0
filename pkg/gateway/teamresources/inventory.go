...
const MeteringRetentionPolicy = "historical metering records, derived request-attribution mappings, and bounded operational delivery records are retained and do not block team deletion"
