...
// InternalGatewayMetrics holds Prometheus metrics for the internal-gateway service.
type InternalGatewayMetrics struct {
...
// NewInternalGateway registers and returns internal-gateway metrics.
// Returns nil when registry is nil.
func NewInternalGateway(registry prometheus.Registerer) *InternalGatewayMetrics {
	if registry == nil {
		return nil
	}
