...
// Dependencies names the Kubernetes and runtime collaborators used by template management.
type Dependencies struct {
	KubernetesClient kubernetes.Interface
	CRDClient        clientset.Interface
	Templates        controller.TemplateLister
...
// New creates a template service from named dependencies.
func New(deps Dependencies) *TemplateService {
	...
	return &TemplateService{
		...
		templateLister:  deps.Templates,
		namespaceLister: deps.Namespaces,
		podLister:       deps.Pods,
		secretLister:    deps.Secrets,
		saLister:        deps.ServiceAccounts,
		logger:          deps.Logger,
