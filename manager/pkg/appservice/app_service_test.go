...
type SandboxAppServiceIngress = managerapi.SandboxAppServiceIngress
type SandboxAppServiceRoute = managerapi.SandboxAppServiceRoute
type SandboxAppServiceRouteAuth = managerapi.SandboxAppServiceRouteAuth
type SandboxAppServiceRouteCORS = managerapi.SandboxAppServiceRouteCORS
type SandboxAppServiceRuntime = managerapi.SandboxAppServiceRuntime
type SandboxFunction = managerapi.SandboxFunction
type SandboxFunctionSource = managerapi.SandboxFunctionSource

const SandboxAppServiceRouteAuthModeHeader = managerapi.SandboxAppServiceRouteAuthModeHeader
const SandboxAppServiceRuntimeCMD = managerapi.SandboxAppServiceRuntimeCMD
const SandboxAppServiceRuntimeFunction = managerapi.SandboxAppServiceRuntimeFunction
const SandboxAppServiceRuntimeManual = managerapi.SandboxAppServiceRuntimeManual
