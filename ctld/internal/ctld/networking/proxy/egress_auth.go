...
func egressAuthEnabled(cfg *config.NetworkRuntimeConfig) bool {
	return cfg != nil && cfg.EgressAuthEnabled
}

func egressAuthFailurePolicy(cfg *config.NetworkRuntimeConfig, rule *policy.CompiledEgressAuthRule) string {
