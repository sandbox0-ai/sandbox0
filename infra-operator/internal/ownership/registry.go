...
func Registry() []Entry {
	return []Entry{
		...
		prefix("spec.database.external", "database", []string{"database", "global-gateway", "regional-gateway", "scheduler", "cluster-gateway", "manager"}, nil, UpdateSemanticsDeclarative, "External database DSN is consumed by database-backed services."),
		...
		exact("spec.redis.type", "plan", []string{"redis", "global-gateway", "regional-gateway", "cluster-gateway", "ctld"}, []string{"InfraPlan.Components.EnableRedis"}, UpdateSemanticsDeclarative, "Selects builtin versus external Redis reconciliation and Redis-capable service config injection."),
		prefix("spec.redis.builtin", "redis", []string{"redis", "global-gateway", "regional-gateway", "cluster-gateway", "ctld"}, nil, UpdateSemanticsDeclarative, "Builtin Redis fields are reconciled by the Redis service and injected into Redis-capable service config."),
		...
		prefix("spec.redis.external", "redis", []string{"redis", "global-gateway", "regional-gateway", "cluster-gateway", "ctld"}, nil, UpdateSemanticsDeclarative, "External Redis URL secret is injected into Redis-capable service config."),
		exact("spec.redis.keyPrefix", "redis", []string{"global-gateway", "regional-gateway", "cluster-gateway", "ctld"}, nil, UpdateSemanticsDeclarative, "Prefixes keys used by Redis-backed service features."),
		exact("spec.redis.operationTimeout", "redis", []string{"global-gateway", "regional-gateway", "cluster-gateway", "ctld"}, nil, UpdateSemanticsDeclarative, "Controls Redis operation timeout for Redis-backed service features."),
		exact("spec.redis.failOpen", "redis", []string{"global-gateway", "regional-gateway", "cluster-gateway", "ctld"}, nil, UpdateSemanticsDeclarative, "Controls service behavior when Redis-backed limiting is unavailable."),
		...
		prefix("spec.sandboxObservability", "sandbox-observability", []string{"sandbox-observability", "cluster-gateway", "ctld", "manager", "status"}, []string{"InfraPlan.Components.EnableSandboxObservability"}, UpdateSemanticsDeclarative, "Region-local per-sandbox historical observability feature, retention, ctld runtime samples, manager logs, netd events, and user-facing query APIs."),
