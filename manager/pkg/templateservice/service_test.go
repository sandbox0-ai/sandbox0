...
func newTemplateServiceForDeleteTests(t *testing.T, k8sClient *fake.Clientset, templates ...*v1alpha1.SandboxTemplate) (*TemplateService, *clientsetfake.Clientset) {
	...
	service := New(Dependencies{
		KubernetesClient: k8sClient,
		CRDClient:        crdClient,
		Templates:        &listBackedTemplateLister{templates: listerTemplates},
		Namespaces:       namespaceLister,
		Pods:             podLister,
		Secrets:          secretLister,
		ServiceAccounts:  serviceAccountLister,
...
func TestDeleteTemplateCleansPodsWhenCRDAlreadyGone(t *testing.T) {
	...
	service := New(Dependencies{
		KubernetesClient: k8sClient,
		CRDClient:        crdClient,
		Templates:        &listBackedTemplateLister{templates: []*v1alpha1.SandboxTemplate{template}},
		Namespaces:       namespaceLister,
		Pods:             podLister,
		Secrets:          secretLister,
		ServiceAccounts:  serviceAccountLister,
