...
var canonicalAuditEventColumns = []auditEventColumnSpec{
	...
	{name: "occurred_at", typeName: "DateTime64(9, 'UTC')", insertPlaceholder: "?"},
	{name: "ingested_at", typeName: "DateTime64(9, 'UTC')", insertPlaceholder: "?"},
...
func (row *auditEventRow) columnBindings() []auditEventColumnBinding {
	return []auditEventColumnBinding{
		...
		{name: "occurred_at", scanDestination: &row.event.OccurredAt, insertValue: dateTime64NanoInsertArg(row.event.OccurredAt)},
		{name: "ingested_at", scanDestination: &row.event.IngestedAt, insertValue: dateTime64NanoInsertArg(row.event.IngestedAt)},
