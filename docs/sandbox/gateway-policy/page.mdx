...
`public_gateway` is the public HTTP exposure model. Configure routes to make sandbox services reachable and to control how requests are accepted before they are proxied to sandbox ports.
</Callout>
