...
func (r *Sandbox0InfraReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if requeue, err := r.ensureTeamQuotaStateIdentity(ctx, infra); err != nil {
		return ctrl.Result{}, err
	} else if requeue {
		return ctrl.Result{Requeue: true}, nil
	}
...
func (r *Sandbox0InfraReconciler) setDefaults(infra *infrav1alpha1.Sandbox0Infra) {
	...
	if infra.Spec.SandboxObservability != nil && infra.Spec.SandboxObservability.Type == "" {
		infra.Spec.SandboxObservability.Type = infrav1alpha1.SandboxObservabilityTypeDisabled
	}
}
...
func (r *Sandbox0InfraReconciler) reconcileComponentPlan(ctx context.Context, infra *infrav1alpha1.Sandbox0Infra, compiledPlan *infraplan.InfraPlan) (ctrl.Result, error) {
	...
	meteringReconciler := meteringsvc.NewReconciler(resources)
...
func (r *Sandbox0InfraReconciler) bindWorkflowSteps(
	...
	meteringReconciler *meteringsvc.Reconciler,
...
func (r *Sandbox0InfraReconciler) workflowStepRunner(
	...
	case "metering":
		return func(ctx context.Context) error { return meteringReconciler.Reconcile(ctx, infra) }, nil
