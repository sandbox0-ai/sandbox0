...
ALTER TABLE manager_sandbox_projection_state
    ...
    ADD COLUMN IF NOT EXISTS function_revision_id TEXT NOT NULL DEFAULT '',
    ADD COLUMN IF NOT EXISTS function_runtime_instance_id TEXT NOT NULL DEFAULT '',
...
CREATE INDEX IF NOT EXISTS idx_manager_sandbox_projection_state_function_id
    ON manager_sandbox_projection_state(function_id)
    WHERE function_id <> '';

-- +goose Down

DROP INDEX IF EXISTS idx_manager_sandbox_projection_state_function_id;
...
ALTER TABLE manager_sandbox_projection_state
    ...
    DROP COLUMN IF EXISTS function_runtime_instance_id,
    DROP COLUMN IF EXISTS function_revision_id,
