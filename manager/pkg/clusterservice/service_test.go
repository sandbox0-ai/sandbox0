...
`)
	...
	svc := &ClusterService{
		podLister: newClusterServicePodLister(t,
			newClusterServicePod("ns-a", "idle-ready", "template-a", sandboxpod.PoolTypeIdle, corev1.PodRunning, true),
			newClusterServicePod("ns-a", "idle-not-ready", "template-a", sandboxpod.PoolTypeIdle, corev1.PodRunning, false),
			newClusterServicePod("ns-a", "idle-pending", "template-a", sandboxpod.PoolTypeIdle, corev1.PodPending, false),
			...
			newClusterServicePod("ns-a", "active-running", "template-a", sandboxpod.PoolTypeActive, corev1.PodRunning, true),
			newClusterServicePod("ns-a", "active-pending-1", "template-a", sandboxpod.PoolTypeActive, corev1.PodPending, false),
			newClusterServicePod("ns-a", "active-pending-2", "template-a", sandboxpod.PoolTypeActive, corev1.PodPending, false),
			newClusterServicePod("ns-a", "active-failed", "template-a", sandboxpod.PoolTypeActive, corev1.PodFailed, false),
		),
...
func TestGetTemplateStatsCountsPendingActivePods(t *testing.T) {
	svc := &ClusterService{
		podLister: newClusterServicePodLister(t,
			...
			newClusterServicePod("ns-a", "active-running", "template-a", sandboxpod.PoolTypeActive, corev1.PodRunning, true),
			newClusterServicePod("ns-a", "active-pending", "template-a", sandboxpod.PoolTypeActive, corev1.PodPending, false),
			newClusterServicePod("ns-a", "active-other-template", "template-b", sandboxpod.PoolTypeActive, corev1.PodPending, false),
			newClusterServicePod("ns-a", "active-failed", "template-a", sandboxpod.PoolTypeActive, corev1.PodFailed, false),
		),
	...
	pod := &corev1.Pod{
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels: map[string]string{
				sandboxpod.LabelTemplateID: templateID,
				sandboxpod.LabelPoolType:   poolType,
			},
		},
...
func newReservedClusterServicePod(namespace, name, templateID string, phase corev1.PodPhase) *corev1.Pod {
	pod := newClusterServicePod(namespace, name, templateID, sandboxpod.PoolTypeIdle, phase, true)
