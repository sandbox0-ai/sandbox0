...
Sandbox0 Cloud restricts new runtime use when prepaid credit is exhausted.
Running sandboxes are automatically paused once outstanding usage and payment
debt reach 10% of the team's most recent successful top-up amount. Without a
successful top-up, any positive debt triggers the pause. Settlement and regional
delivery are asynchronous, so this is a pause threshold rather than a precise
limit on final charges.
