...
// New builds the immutable rootfs object store shared by ctld checkpointing
// and the external lazy snapshotter.
func New(cfg *apiconfig.StorageProxyConfig, requestObserver objectstore.RequestObserver) (objectstore.Store, error) {
	if cfg == nil {
