...
func configureNodePoolAutoscaler(
	...
	return nodepoolautoscaler.New(store, cloud, nodepoolautoscaler.Config{
		...
		HeadroomMemoryBytes:   nodePool.HeadroomMemoryBytes,
		HeadroomSlots:         nodePool.HeadroomSlots,
		...
		FixedReplacementDebounce:  nodePool.FixedReplacementDebounce.Duration,
		...
		ConsolidationMaxSandboxes: nodePool.ConsolidationMaxSandboxes,
