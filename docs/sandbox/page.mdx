...
<Callout variant="info">
Metering windows remain the PostgreSQL usage truth for quota, showback, and billing export. Historical observability does not store metering windows in ClickHouse. File audit is not part of these endpoints.
</Callout>
