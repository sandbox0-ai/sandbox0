...
var (
	...
	ErrRequestCapacity              = errors.New("recoverable request result capacity exhausted")
	ErrRequestCompletionUnavailable = errors.New("recoverable request completion unavailable")
	ErrRequestResultMissing         = errors.New("recoverable resend result is missing")
