...
func filterRootFSDiffTarForSave(desc ctldapi.RootFSDiffDescriptor, reader io.Reader, excludedPaths []string) (ctldapi.RootFSDiffDescriptor, io.ReadSeekCloser, error) {
	return filterRootFSDiffTar(desc, reader, excludedPaths)
}
...
func writeRootFSDiffTarForApply(dst io.Writer, desc ctldapi.RootFSDiffDescriptor, reader io.Reader, excludedPaths []string) (ctldapi.RootFSDiffDescriptor, rootFSDiffFilterStats, error) {
	filter := newRootFSPathFilter(excludedPaths)
