...
func main() {
	...
	flag.Int64Var(&config.RootFSDirtyTailRetirementReserveBytes, "dirty-tail-retirement-reserve-bytes", 64<<20, "shared node capacity protected for filesystem sync and unmount")
