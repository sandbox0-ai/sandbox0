...
The rootfs checkpoint covers files written inside the sandbox filesystem. It is tied to the sandbox lifecycle. For named rootfs snapshots, restore, and fork operations, see [Snapshot And Restore](/docs/sandbox/snapshot-restore).
