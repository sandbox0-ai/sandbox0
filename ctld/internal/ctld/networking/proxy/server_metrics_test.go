...
func TestAcceptLoopTracksActiveTCPProxyConnectionsByListener(t *testing.T) {
	...
	connections := prometheus.NewGaugeVec(prometheus.GaugeOpts{
		Name: "ctld_network_proxy_connections_active",
	...
	if got, err := testutil.GatherAndCount(registry, "ctld_network_proxy_connections_active"); err != nil || got != 2 {
		t.Fatalf("gather ctld_network_proxy_connections_active = %d, %v; want 2 labeled metrics", got, err)
	}
